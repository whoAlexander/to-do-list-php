...
// 4. Buscamos las tareas pendientes del usuario
    ...
    $sql_tareas = "
        ...
        WHERE t.usuario_id = ? AND t.estado = 0 AND t.lista_id IS NULL
    ...
    <div class="d-flex" style="height: 100vh;"> 
        ...
        <div class="glass-sidebar p-4 d-flex flex-column h-100" style="width: 280px;">
            ...
            <ul class="nav flex-column gap-3 mb-auto">
                ...
                <li class="nav-item ">
                    <a class="nav-link active d-flex align-items-center gap-3 py-1" style="font-size: 0.9rem;" href="bandejaDeEntrada.php">
