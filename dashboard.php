                ...
                <li class="nav-item">
                    ...
                    <?php if (!empty($listas_usuario)): ?>
                            ...
                            <?php foreach ($listas_usuario as $lista): ?>
                                <li class="nav-item">
                                    <a class="nav-link d-flex align-items-center gap-2 py-1 text-white-50" style="font-size: 0.9rem;" href="dashboard.php?lista=<?php echo $lista['id_lista']; ?>">
                                        <i class="bi bi-dot"></i>
                            ...
                            <?php foreach ($tareas_usuario as $tarea): ?>
                                ...
                                <div class="glass-form-element p-3 rounded d-flex justify-content-between align-items-start">
                                    ...
                                    <div class="d-flex gap-3 flex-grow-1">
                                        ...
                                        <!-- Checkbox visual (luego programaremos completarlo) -->
                                        <div class="mt-1">
                                            <i class="bi bi-circle text-white-50 fs-5" style="cursor: pointer;"></i>
                                        </div>
